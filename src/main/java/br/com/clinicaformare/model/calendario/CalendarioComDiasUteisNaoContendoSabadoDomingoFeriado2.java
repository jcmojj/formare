...
@Entity
public class CalendarioComDiasUteisNaoContendoSabadoDomingoFeriado2  implements Calendario, Serializable {
	...
	// Constructor
	public CalendarioComDiasUteisNaoContendoSabadoDomingoFeriado2() {
	}

	public CalendarioComDiasUteisNaoContendoSabadoDomingoFeriado2(LocalDate data) {
		this.data = data;
		this.nomeFeriado = "";
		this.diaUtil = true;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CalendarioComDiasUteisNaoContendoSabadoDomingoFeriado2 other = (CalendarioComDiasUteisNaoContendoSabadoDomingoFeriado2) obj;
		if (id == null) {
			if (other.id != null)
				return false;
