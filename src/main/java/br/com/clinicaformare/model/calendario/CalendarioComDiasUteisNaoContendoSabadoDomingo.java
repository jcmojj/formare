...
@Entity
public class CalendarioComDiasUteisNaoContendoSabadoDomingo  implements Calendario, Serializable {
	...
	// Constructor
	public CalendarioComDiasUteisNaoContendoSabadoDomingo() {
	}

	public CalendarioComDiasUteisNaoContendoSabadoDomingo(LocalDate data) {
		this.data = data;
		this.nomeFeriado = "";
		this.diaUtil = true;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CalendarioComDiasUteisNaoContendoSabadoDomingo other = (CalendarioComDiasUteisNaoContendoSabadoDomingo) obj;
		if (id == null) {
			if (other.id != null)
				return false;
