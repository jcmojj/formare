...
@Entity
public class CalendarioComDiasUteisNaoContendoSabadoDomingoFeriado  implements Calendario, Serializable {
	...
	// Constructor
	public CalendarioComDiasUteisNaoContendoSabadoDomingoFeriado() {
	}

	public CalendarioComDiasUteisNaoContendoSabadoDomingoFeriado(LocalDate data) {
		this.data = data;
		this.nomeFeriado = "";
		this.diaUtil = true;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CalendarioComDiasUteisNaoContendoSabadoDomingoFeriado other = (CalendarioComDiasUteisNaoContendoSabadoDomingoFeriado) obj;
		if (id == null) {
			if (other.id != null)
				return false;
