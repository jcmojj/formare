...
@Entity
public class CalendarioComDiasUteisNaoContendoDomingo  implements Calendario, Serializable {
	...
	// Constructor
	public CalendarioComDiasUteisNaoContendoDomingo() {
	}

	public CalendarioComDiasUteisNaoContendoDomingo(LocalDate data) {
		this.data = data;
		this.nomeFeriado = "";
		this.diaUtil = true;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CalendarioComDiasUteisNaoContendoDomingo other = (CalendarioComDiasUteisNaoContendoDomingo) obj;
		if (id == null) {
			if (other.id != null)
				return false;
